...
//   LIDAR A1M8
// ============================================================
#define LIDAR_RX_PIN      47 // Gắn vào TX của Lidar
#define LIDAR_TX_PIN      46 // Gắn vào RX của Lidar
...
#define COMP_FILTER_ALPHA 0.95f    // Complementary filter (0=encoder only, 1=gyro only)
...
#define INA_CH_BATT   1 // Kênh 2 (CH2): Đo Pin tổng (áp & dòng) - Thay thế cho CH1
